cube(`Events`, {
    ...
    measures: {
        count: {
            type: `count`,
            drillMembers: [eventTime, eventTimeTS, requestId, appId, adSetId, chId, userId, offerId, creativeId, eventId, eventType, geo, device, osVersion, deviceIp, placementId, ifa]
        },
        events: {
            sql: `eventId`,
            type: `count`,
